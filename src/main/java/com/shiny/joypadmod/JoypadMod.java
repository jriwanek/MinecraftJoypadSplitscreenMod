...
@Mod(modid = JoypadMod.MODID, name = JoypadMod.NAME, version = JoypadMod.VERSION, clientSideOnly = true, acceptedMinecraftVersions = "[1.12,1.12.2]")
public class JoypadMod {
    ...
    public static final String VERSION = "1.12.2-14.23.5.2847";
